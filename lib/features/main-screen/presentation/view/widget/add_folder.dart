              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    BlocBuilder<AddFolderLoadingCubit, AddFolderLoadingState>(
                        ...
                        return ElevatedButton(
                            onPressed: () async {
                              if (selectedImage.isEmpty ||
                                ...
                                try {
                                  context
                                      .read<AddFolderLoadingCubit>()
                                      .addFolderLoading(true);

                                  await context
                                      .read<AddFolderLoadingCubit>()
                                      .crateFolder(selectedImage,
                            ...
                            child: state is AddFolderLoading && state.loading
